    ...
    <div className="bg-card/80 backdrop-blur-xl border-r border-border shadow-lg shadow-gray-100/50 dark:shadow-none h-full flex flex-col">
      ...
      <div className="flex-1 p-2 overflow-y-auto overscroll-contain">
        <nav className="space-y-1">
          ...
          {currentUser && getAllowedDashboards(userRoles).filter(path => path !== '/dashboard/admin' && path !== '/dashboard/inventory' && path !== '/dashboard/keys' && path !== '/dashboard/wireless-mics').length > 0 && (
            <>
              ...
              {getAllowedDashboards(userRoles)
                .filter(path => path !== '/dashboard/admin' && path !== '/dashboard/inventory' && path !== '/dashboard/keys' && path !== '/dashboard/wireless-mics')
                .map(path => {
